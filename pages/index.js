  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-stone-950 ">
        <div className=" absolute top-2 right-16 justify-end place-items-center flex">
        ...
        <div className="flex flex-col">
          ...
          <div className="order-5 place-self-center flex flex-col">
            <div className="order-1 place-self-center pb-6">
              <h1 className="font-semibold text-2xl underline">ShawReviews</h1>
            </div>
            ...
            <div className="order-3 flex border-2">
          ...
          <div className="order-7 flex h-80 w-full bg-white skew-y-3 py-6 ">
            <div className="flex flex-col">
                  ...
                  <li className="text-black order-2 pl-12 pt-4 -skew-y-3">
                    UI component libraries like <strong>Radix UI</strong> and <strong>Material UI</strong>               
                  </li>
                  <li className="text-black order-2 pl-12 pt-4 -skew-y-3">
                    Tanstack Query               
                  </li>
